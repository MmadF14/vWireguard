const translations = {
    ...
    fa: {
        ...
        "WireGuard to WireGuard": "WG به WG",
        ...
        // Complete Tunnel page translations
        "Tunnel Routing Setup Required": "تنظیم مسیریابی تانل مورد نیاز است",
        "For tunnels to work properly, you need to set up routing rules on your server. Run this command as root:": "برای عملکرد صحیح تانل‌ها، باید قوانین مسیریابی را روی سرور خود تنظیم کنید. این دستور را به عنوان root اجرا کنید:",
        "This will configure iptables rules for traffic forwarding and enable IP forwarding.": "این کار قوانین iptables برای هدایت ترافیک را پیکربندی کرده و IP forwarding را فعال می‌کند.",
        "Important Notes": "نکات مهم",
        "Safe Routing:": "مسیریابی امن:",
        "is automatically replaced with private networks to prevent server disconnection": "به طور خودکار با شبکه‌های خصوصی جایگزین می‌شود تا از قطع اتصال سرور جلوگیری شود",
        "Edit Restriction:": "محدودیت ویرایش:",
        ...
        "Interface Names:": "نام‌های رابط:",
        "Tunnel interfaces use format": "رابط‌های تانل از فرمت استفاده می‌کنند",
        "Traffic Forwarding:": "هدایت ترافیک:",
        "Ensure your server has proper iptables rules for traffic forwarding": "مطمئن شوید سرور شما دارای قوانین iptables مناسب برای هدایت ترافیک است",
        "Manage network tunnels and routing": "مدیریت تانل‌های شبکه و مسیریابی",
        "New Tunnel": "تانل جدید",
        "Cleanup": "پاکسازی",
        "Type": "نوع",
        ...
        // Modal and cleanup translations
        "Cancel": "لغو",
        "Create Tunnel": "ایجاد تانل",
        ...
        // Additional Tunnels page translations that might be missing
        ...
        "active": "فعال",
        "inactive": "غیرفعال",
        "185.88.152.107:32100": "185.88.152.107:32100",
        ...
        // Server configuration saving states
        "Saving...": "در حال ذخیره...",
        "Save Settings": "ذخیره تنظیمات",
        "Processing...": "در حال پردازش...",
        "Settings saved successfully": "تنظیمات با موفقیت ذخیره شد",
        "An error occurred while saving settings": "خطایی در هنگام ذخیره تنظیمات رخ داد",
        "Error saving settings": "خطا در ذخیره تنظیمات",
        
        // Additional form and UI elements
        "All traffic": "تمام ترافیک",
        "Enter private key here...": "کلید خصوصی را اینجا وارد کنید...",
        "Public key will be auto-generated": "کلید عمومی به طور خودکار تولید می‌شود",
        "Enter target IP:Port": "IP:Port هدف را وارد کنید",
        "Enter your tunnel IP": "IP تانل خود را وارد کنید",
        "Enter remote public key": "کلید عمومی راه دور را وارد کنید",
        "Enter allowed IPs": "IP های مجاز را وارد کنید",
        "Leave empty for no preshared key": "برای عدم استفاده از کلید از پیش تعیین شده خالی بگذارید",
        
        // Additional status and UI translations
        "Starting...": "در حال شروع...",
        "Stopping...": "در حال توقف...",
        "Tunnel started successfully!": "تانل با موفقیت راه‌اندازی شد!",
        "Tunnel stopped successfully!": "تانل با موفقیت متوقف شد!",
        "Error starting tunnel": "خطا در راه‌اندازی تانل",
        "Error stopping tunnel": "خطا در توقف تانل",
        "Request timeout - tunnel start is taking too long": "زمان درخواست تمام شد - راه‌اندازی تانل خیلی طول می‌کشد",
        "Request timeout - tunnel stop is taking too long": "زمان درخواست تمام شد - توقف تانل خیلی طول می‌کشد",
        "Are you sure you want to cleanup corrupted tunnels? This action cannot be undone!": "آیا مطمئن هستید که می‌خواهید تانل‌های خراب را پاکسازی کنید؟ این عمل قابل برگشت نیست!",
        "Tunnel cleanup completed successfully!": "پاکسازی تانل با موفقیت تکمیل شد!",
        "Error cleaning up tunnels": "خطا در پاکسازی تانل‌ها",
        "⚠️ WARNING: This will delete ALL tunnels permanently!": "⚠️ هشدار: این عمل تمام تانل‌ها را برای همیشه حذف می‌کند!",
        "⚠️ FINAL CONFIRMATION: Delete ALL tunnel records?": "⚠️ تأیید نهایی: حذف تمام رکوردهای تانل؟",
        "All tunnels deleted successfully!": "تمام تانل‌ها با موفقیت حذف شدند!",
        "Error deleting tunnels": "خطا در حذف تانل‌ها",
        "Failed to refresh tunnel statistics": "خطا در بروزرسانی آمار تانل",
        "Tunnel stats refreshed": "آمار تانل بروزرسانی شد",
        
        // Byte size translations
        "0 B": "0 بایت",
        "bytes": "بایت",
        "KB": "کیلوبایت",
        "MB": "مگابایت",
        ...
        "Please enter only digits": "لطفاً فقط اعداد وارد کنید",
        "Please enter the same value again": "لطفاً همان مقدار را دوباره وارد کنید",
        "Please enter no more than {0} characters": "لطفاً حداکثر {0} کاراکتر وارد کنید",
        "Please enter at least {0} characters": "لطفاً حداقل {0} کاراکتر وارد کنید",
        "Please enter a value between {0} and {1}": "لطفاً مقداری بین {0} و {1} وارد کنید"
    }
}; 